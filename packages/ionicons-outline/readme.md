...
<h3 align="center">
  ...
  [Ionicons Outline][ionicons-outline] icon pack as dependency-free Svelte components
</h3>
...
```sh
yarn add -D @svicons/ionicons-outline
```
...
```svelte
<script>
  import Accessibility from '@svicons/ionicons-outline/accessibility.svelte
</script>
