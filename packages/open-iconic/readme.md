...
<h3 align="center">
  ...
  [Open Iconic][open-iconic] icon pack as dependency-free Svelte components
</h3>
...
```sh
yarn add -D @svicons/open-iconic
```
...
```svelte
<script>
  import AccountLogin from '@svicons/open-iconic/account-login.svelte
</script>

<AccountLogin width="3em" color="green" />
```
