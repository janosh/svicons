...
<h2 align="center">
  ...
  [Evaicons Solid][evaicons-solid] icon pack as dependency-free Svelte components
</h2>
...
```sh
yarn add -D @svicons/evaicons-solid
```
...
```svelte
<script>
  import Activity from '@svicons/evaicons-solid/activity.svelte
</script>

<Activity width="3em" color="green" />
```
