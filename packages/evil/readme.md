...
<h2 align="center">
  ...
  [Evil][evil] icon pack as dependency-free Svelte components
</h2>
...
```svelte
<script>
  import Archive from '@svicons/evil/archive.svelte
</script>

<Archive width="3em" color="green" />
```
