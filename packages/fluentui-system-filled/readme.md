...
<h3 align="center">
  ...
  [Fluentui System Filled][fluentui-system-filled] icon pack as dependency-free Svelte components
</h3>
...
```sh
yarn add -D @svicons/fluentui-system-filled
```
...
```svelte
<script>
  import AccessTime from '@svicons/fluentui-system-filled/access-time.svelte
</script>
