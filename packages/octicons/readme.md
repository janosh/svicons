...
<h2 align="center">
  ...
  [Octicons][octicons] icon pack as dependency-free Svelte components
</h2>
...
```svelte
<script>
  import Alert from '@svicons/octicons/alert.svelte
</script>

<Alert width="3em" color="green" />
```
