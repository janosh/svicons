...
<h2 align="center">
  ...
  [Fa Brands][fa-brands] icon pack as dependency-free Svelte components
</h2>
...
```svelte
<script>
  import AccessibleIcon from '@svicons/fa-brands/accessible-icon.svelte
</script>

<AccessibleIcon width="3em" color="green" />
```
