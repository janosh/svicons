...
<h2 align="center">
  ...
  [Material Outlined][material-outlined] icon pack as dependency-free Svelte components
</h2>
...
```sh
yarn add -D @svicons/material-outlined
```
...
```svelte
<script>
  import AcUnit from '@svicons/material-outlined/ac-unit.svelte
</script>
