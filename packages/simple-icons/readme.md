...
[Simple Icons][simple-icons] icon pack as dependency-free Svelte components
...
```sh
yarn add -D @svicons/simple-icons
```
...
```svelte
<script>
  import AFrame from '@svicons/simple-icons/a-frame.svelte
</script>

<AFrame width="3em" color="green" />
```
