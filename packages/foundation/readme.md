...
<h3 align="center">
  ...
  [Foundation][foundation] icon pack as dependency-free Svelte components
</h3>
...
```svelte
<script>
  import AddressBook from '@svicons/foundation/address-book.svelte
</script>

<AddressBook width="3em" color="green" />
```
