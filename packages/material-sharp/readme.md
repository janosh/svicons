...
[Material Sharp][material-sharp] icon pack as dependency-free Svelte components
...
```sh
yarn add -D @svicons/material-sharp
```
...
```svelte
<script>
  import AcUnit from '@svicons/material-sharp/ac-unit.svelte
</script>
