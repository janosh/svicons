...
[Bootstrap][bootstrap] icon pack as dependency-free Svelte components
...
```svelte
<script>
  import AlarmFill from '@svicons/bootstrap/alarm-fill.svelte
</script>

<AlarmFill width="3em" color="green" />
```
