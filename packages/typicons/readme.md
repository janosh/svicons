...
[Typicons][typicons] icon pack as dependency-free Svelte components
...
```svelte
<script>
  import AdjustBrightness from '@svicons/typicons/adjust-brightness.svelte
</script>

<AdjustBrightness width="3em" color="green" />
```
