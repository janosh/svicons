...
<h2 align="center">
  ...
  [Icomoon][icomoon] icon pack as dependency-free Svelte components
</h2>
...
```svelte
<script>
  import Accessibility from '@svicons/icomoon/accessibility.svelte
</script>
