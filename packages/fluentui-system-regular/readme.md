...
<h2 align="center">
  ...
  [Fluentui System Regular][fluentui-system-regular] icon pack as dependency-free Svelte components
</h2>
...
```sh
yarn add -D @svicons/fluentui-system-regular
```
...
```svelte
<script>
  import AccessTime from '@svicons/fluentui-system-regular/access-time.svelte
</script>

<AccessTime width="3em" color="green" />
```
