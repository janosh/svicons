...
[Zondicons][zondicons] icon pack as dependency-free Svelte components
...
```svelte
<script>
  import AddOutline from '@svicons/zondicons/add-outline.svelte
</script>

<AddOutline width="3em" color="green" />
```
