...
<h2 align="center">
  ...
  [Fa Regular][fa-regular] icon pack as dependency-free Svelte components
</h2>
...
```svelte
<script>
  import AddressBook from '@svicons/fa-regular/address-book.svelte
</script>
