...
<h3 align="center">
  ...
  [Remix Line][remix-line] icon pack as dependency-free Svelte components
</h3>
...
```svelte
<script>
  import AccountBox from '@svicons/remix-line/account-box.svelte
</script>
