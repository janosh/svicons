...
<h3 align="center">
  ...
  [Entypo][entypo] icon pack as dependency-free Svelte components
</h3>
...
```svelte
<script>
  import AddToList from '@svicons/entypo/add-to-list.svelte
</script>

<AddToList width="3em" color="green" />
```
