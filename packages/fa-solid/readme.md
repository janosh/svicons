...
<h2 align="center">
  ...
  [Fa Solid][fa-solid] icon pack as dependency-free Svelte components
</h2>
...
```svelte
<script>
  import Ad from '@svicons/fa-solid/ad.svelte
</script>

<Ad width="3em" color="green" />
```
