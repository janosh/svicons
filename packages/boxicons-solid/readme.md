...
<h2 align="center">
  ...
  [Boxicons Solid][boxicons-solid] icon pack as dependency-free Svelte components
</h2>
...
```sh
yarn add -D @svicons/boxicons-solid
```
...
```svelte
<script>
  import AddToQueue from '@svicons/boxicons-solid/add-to-queue.svelte
</script>

<AddToQueue width="3em" color="green" />
```
