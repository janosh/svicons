...
<h3 align="center">
  ...
  [Boxicons Regular][boxicons-regular] icon pack as dependency-free Svelte components
</h3>
...
```sh
yarn add -D @svicons/boxicons-regular
```
...
```svelte
<script>
  import Abacus from '@svicons/boxicons-regular/abacus.svelte
</script>

<Abacus width="3em" color="green" />
```
