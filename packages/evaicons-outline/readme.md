...
<h2 align="center">
  ...
  [Evaicons Outline][evaicons-outline] icon pack as dependency-free Svelte components
</h2>
...
```sh
yarn add -D @svicons/evaicons-outline
```
...
```svelte
<script>
  import ActivityOutline from '@svicons/evaicons-outline/activity-outline.svelte
</script>

<ActivityOutline width="3em" color="green" />
```
