...
<h2 align="center">
  ...
  [Heroicons Outline][heroicons-outline] icon pack as dependency-free Svelte components
</h2>
...
```sh
yarn add -D @svicons/heroicons-outline
```
...
```svelte
<script>
  import AcademicCap from '@svicons/heroicons-outline/academic-cap.svelte
</script>

<AcademicCap width="3em" color="green" />
```
