...
<h2 align="center">
  ...
  [Boxicons Logos][boxicons-logos] icon pack as dependency-free Svelte components
</h2>
...
```sh
yarn add -D @svicons/boxicons-logos
```
...
```svelte
<script>
  import Adobe from '@svicons/boxicons-logos/adobe.svelte
</script>

<Adobe width="3em" color="green" />
```
