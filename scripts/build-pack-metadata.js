...
fs.writeFileSync(`site/src/iconKeys.ts`, `export default ${JSON.stringify(iconNames)}`)
...
fs.writeFileSync(`site/src/packLengths.ts`, `export default ${JSON.stringify(lengthData)}`)
